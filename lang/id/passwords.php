...
return [
    ...
    */
    ...
    'token' => 'Link ini sudah tidak berlaku untuk melakukan reset kata sandi.',
    'user' => 'Kami tidak dapat menemukan pengguna dengan alamat surel tersebut.',
    'throttled' => 'Anda sudah melakukan reset kata sandi, silakan cek email anda atau coba beberapa saat lagi',
];
